...
import { getCRSIStream, getCRSIStream2 } from './indicators/crsi';
...
(async function() {
    ...
    const conditions = {
      scalper: {
        buy: {
          long:
            botState.initialDealType === 'short'
              ...
              : botState.status === 'buy' &&
                ...
                // indicatorsData.stochRsi.stoch5m.buySignalCount >= 3 &&
                // indicatorsData.stochRsi.stoch3m.buySignalCount >= 3 &&
                indicatorsData.stochRsi.stoch1m.sellSignalCount >= 5 &&
                ...
                // indicatorsData.efi15m.prevEfi >= 25 &&
                ...
                // indicatorsData.dmi1h.adxBuySignalVolume >= 1 &&
                // indicatorsData.dmi4h.adxBuySignalVolume >= 1,
                // ||
          ...
          // indicatorsData.dmi1m_1.adxBuySignalVolume >= 8 &&
          ...
          short:
            botState.initialDealType === 'long'
              ...
              : botState.status === 'buy' &&
                ...
                indicatorsData.stochRsi.stoch1m.buySignalCount >= 5 &&
                // indicatorsData.dmi1m.adxBuySignalVolume >= 1 &&
                // indicatorsData.dmi5m.adxBuySignalVolume >= 1 &&
                // indicatorsData.stochRsi.stoch5m.sellSignalCount >= 3 &&
                // indicatorsData.stochRsi.stoch3m.sellSignalCount >= 3 &&
                // indicatorsData.stochRsi.stoch1m.sellSignalCount >= 3 &&
          ...
          //   indicatorsData.dmi5m.adxBuySignalVolume >= 2 &&
          //   indicatorsData.dmi15m.adxBuySignalVolume >= 2 &&
          //   indicatorsData.dmi30m.adxBuySignalVolume >= 2 &&
          //   indicatorsData.dmi1h.adxBuySignalVolume >= 2 &&
          //   indicatorsData.dmi4h.adxBuySignalVolume >= 2)
          // indicatorsData.obv1m.sellSignalCount >= 2 &&
          // indicatorsData.dmi4h.adxBuySignalVolume >= 3 &&
          // indicatorsData.dmi1m.adxBuySignalVolume >= 2 &&
          // indicatorsData.dmi5m.adxBuySignalVolume >= 2,
          ...
          // indicatorsData.dmi1m.adxBuySignalVolume >= 8 &&
          // indicatorsData.dmi1m_1.adxBuySignalVolume >= 8 &&
          // indicatorsData.dmi1m_2.adxBuySignalVolume >= 8,
          // indicatorsData.dmi1m.adxSellSignalVolume >= 10),
        ...
        sell: {
          ...
          stopLoss: {
            ...
            // indicatorsData.dmi4h.adxBuySignalVolume >= 1,
            // ((indicatorsData.obv15m.sellSignalCount >= 4 &&
            //   indicatorsData.dmi1m.adxSellSignalVolume >= 1 &&
            //   indicatorsData.dmi5m.adxSellSignalVolume >= 1 &&
            //   indicatorsData.dmi15m.adxSellSignalVolume >= 1 &&
            //   indicatorsData.dmi30m.adxSellSignalVolume >= 1 &&
            //   indicatorsData.dmi1h.adxSellSignalVolume >= 1 &&
            //   indicatorsData.dmi4h.adxSellSignalVolume >= 1) ||
            //   (indicatorsData.obv15m.sellSignalCount >= 4 &&
            //     indicatorsData.dmi1m.adxBuySignalVolume >= 1 &&
            //     indicatorsData.dmi5m.adxBuySignalVolume >= 1 &&
            //     indicatorsData.dmi15m.adxBuySignalVolume >= 1 &&
  ...
  //   // .pipe(pluck('price'), bufferCount(1, 1))
  //   .subscribe(trade => {
  //     indicatorsData.printsLength.deals.push(trade);
  //     // console.log(
  //     //   `Side: ${!trade.isBuyerMarketMaker ? 'BUY' : 'SELL'} Price: ${
  //     //     trade.price
  ...
  // getStochRSISignal(symbol, '15m', indicatorsData.stochRsi.stoch5m);
  // getStochRSISignal(symbol, '5m', indicatorsData.stochRsi.stoch3m);
  ...
  getObvSignal(symbol, '1m', indicatorsData.obv1m, 60, 60, false);
  getObvSignal(symbol, '5m', indicatorsData.obv5m, 60, 60, false);
  getDMISignal(symbol, '5m', 2, indicatorsData.dmi1m, botState, true, true);
  getDMISignal(symbol, '5m', 4, indicatorsData.dmi5m, botState, true, true);
  getDMISignal(symbol, '5m', 8, indicatorsData.dmi15m, botState, true, true);
  ...
  // getStochRSISignal(symbol, '5m', indicatorsData.stochRsi.stoch5m);
  // getObvSignal(symbol, '1d', indicatorsData.obv1d, 2, 2, false);
  // getObvSignal(symbol, '4h', indicatorsData.obv4h, 2, 2, false);
  // getObvSignal(symbol, '2h', indicatorsData.obv2h, 2, 2, false);
  // getObvSignal(symbol, '45m', indicatorsData.obv30m, 2, 2, false);
  // getObvSignal(symbol, '30m', indicatorsData.obv30m, 60, 60, true);
  // getMfiSignal(symbol, '1m', , indicatorsData.obv1m, 1, 1, false);
  // getMfiSignal(symbol, '15m', 4, indicatorsData.obv5m, 1, 1, false);
  // getMfiSignal(symbol, '15m', 8, indicatorsData.obv15m, 1, 1, false);
  ...
  // getForceIndexSignal(symbol, '1m', 1, indicatorsData.efi15m, true);
  // getObvSignal(symbol, '5m', indicatorsData.obv15m, 60, 60, true);
  // getObvSignal(symbol, '30m', indicatorsData.obv1h, 60, 60, true);
  // getDMISignal(symbol, '1m', 8, indicatorsData.dmi30m, botState, true, true);
  // getDMISignal(symbol, '1m', 13, indicatorsData.dmi1h, botState, true, true);
  // getDMISignal(symbol, '1m', 21, indicatorsData.dmi4h, botState, true, true);
  // getDMISignal(symbol, '1m', 8, indicatorsData.dmi15m, botState, true, false);
  // getDMISignal(
  //   symbol,
  //   '15m',
  //   4,
  //   indicatorsData.dmi15m_1,
  //   botState,
  //   true,
  //   false,
  // );
  ...
  // getDMISignal(symbol, '15m', 4, indicatorsData.dmi15m, botState, true, true);
  // getDMISignal(symbol, '30m', 2, indicatorsData.dmi4h, botState, true, true);
  ...
  // getDMISignal(symbol, '5m', 2, indicatorsData.dmi1m_1, botState, true, true);
  // getDMISignal(symbol, '1m', 7, indicatorsData.dmi1m_1, botState, true, false);
  // getStochRSISignal(symbol, '15m', indicatorsData.stochRsi.stoch15m, 2.5, 2.5);
  // getRSISignal(symbol, '15m', 4, indicatorsData.rsi5m);
  // getRSISignal(symbol, '15m', 14, indicatorsData.rsi15m);
  ...
  // getDMISignal(symbol, '4h', 2, indicatorsData.dmi4h, botState, true, false);
  // getDMISignal(symbol, '5m', 4, indicatorsData.dmi5m, botState, true, false);
  ...
  (() => {
    setInterval(async () => {
      ...
      const printsDealsQtyTotal = getSum(
        indicatorsData.printsLength.deals.map(({ quantity }) => quantity),
      );
      console.log('Current print qty: ' + printsDealsQtyTotal);
      console.log(
        'Prev print qty: ' + indicatorsData.printsLength.prevQtyTotal,
      );
      if (!indicatorsData.printsLength.prevQtyTotal)
        indicatorsData.printsLength.prevQtyTotal = printsDealsQtyTotal;
      else {
        indicatorsData.printsLength.prevQtyTotal = printsDealsQtyTotal;
        indicatorsData.printsLength.deals.length = 0;
      }
      ...
      // console.log(
      //   'RSI 5m: ' +
      //     indicatorsData.rsi5m.rsiValue +
      //     'up: ' +
      //     indicatorsData.rsi5m.growCount +
      //     'down : ' +
      ...
      //     ')',
      // );
      // console.log('ATR 1m: ' + indicatorsData.atr.atr1m.prevAtr);
      ...
      //     ' ' +
      //     'Current: ' +
      //     indicatorsData.efi15m.prevEfi +
      //     ')',
      // );
      // console.log(
      //   'ADX 1m_1: ' +
      //     '(UP: ' +
      //     indicatorsData.dmi1m_1.adxBuySignalVolume +
      //     ' DOWN: ' +
      //     indicatorsData.dmi1m_1.adxSellSignalVolume +
      //     ' ' +
      //     'Current: ' +
      //     indicatorsData.dmi1m_1.adx,
      //   ')',
      // );
      // console.log(
      //   'ADX 1m_2: ' +
      //     '(UP: ' +
      //     indicatorsData.dmi1m_2.adxBuySignalVolume +
      //     ' DOWN: ' +
      //     indicatorsData.dmi1m_2.adxSellSignalVolume +
      //     ' ' +
      //     'Current: ' +
      //     indicatorsData.dmi1m_2.adx,
      //   ')',
      // );
      console.log(
        'ADX 5m: ' +
      ...
      //   'ADX 15m_1: ' +
      //     '(UP: ' +
      //     indicatorsData.dmi15m_1.adxBuySignalVolume +
      //     ' DOWN: ' +
      //     indicatorsData.dmi15m_1.adxSellSignalVolume +
      //     ' ' +
      //     'Current: ' +
      //     indicatorsData.dmi15m_1.adx,
      //   ')',
      // );
      // console.log(
      //   'ADX 15m_2: ' +
      //     '(UP: ' +
      //     indicatorsData.dmi15m_2.adxBuySignalVolume +
      //     ' DOWN: ' +
      //     indicatorsData.dmi15m_2.adxSellSignalVolume +
      //     ' ' +
      //     'Current: ' +
      //     indicatorsData.dmi15m_2.adx,
      //   ')',
      // );
      //
      console.log(
      ...
      console.log(
        'STOCH 1m: ' + JSON.stringify(indicatorsData.stochRsi.stoch1m.data),
        'Buy Count: ' + indicatorsData.stochRsi.stoch1m.buySignalCount,
        'Sell Count: ' + indicatorsData.stochRsi.stoch1m.sellSignalCount,
      );
        ...
        console.log(
          botState.dealType === 'long'
            ? 'MAX av profit: ' +
                ...
                Number(
                  botState.buyPrice +
                    (botState.buyPrice * botState.maxAvailableLongProfit) / 100,
                ) +
                ' )' +
            ...
            : 'MAX av profit: ' +
                ...
                Number(
                  botState.buyPrice +
                    (botState.buyPrice * botState.maxAvailableShortProfit) /
                      100,
                ) +
                ' )' +
                (botState.traidingMarket === 'futures' && botState.order
        ...
        console.log(
          botState.dealType === 'long'
            ? 'MIN av profit: ' +
                ...
                Number(
                  botState.buyPrice +
                    (botState.buyPrice * botState.minAvailableLongProfit) / 100,
                ) +
                ' )' +
                (botState.traidingMarket === 'futures' && botState.order
                  ? (Number(botState.minAvailableLongProfit - fee) *
            ...
            : 'MIN av profit: ' +
                ...
                Number(
                  botState.buyPrice +
                    (botState.buyPrice * botState.minAvailableShortProfit) /
                      100,
                ) +
                ' )' +
                (botState.traidingMarket === 'futures' && botState.order
  ...
  //       const shortBids = binance.array(bids).slice(0, 200);
  //       const shortAsks = binance.array(asks).slice(0, 200);
  ...
  //       const diff = (sellVolume / buyVolume) * 100 - 100;
  ...
  //       // console.log(
  //       //   'bids',
  //       //   shortBids.filter(arr => arr[1] >= 1000),
  //       // );
  //       // console.log(
  //       //   'asks',
  //       //   shortAsks.filter(arr => arr[1] >= 1000),
  //       // );
