...
(async function() {
  ...
  getDMISignal(symbol, '1m', 5, indicatorsData.dmi30m, botState, true, true);
  getDMISignal(symbol, '1m', 6, indicatorsData.dmi1h, botState, true, true);
  getDMISignal(symbol, '1m', 7, indicatorsData.dmi4h, botState, true, true);
